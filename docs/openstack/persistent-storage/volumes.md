...
!!! danger "Very Important: Requested/Approved Allocated Storage Quota and Cost"
    ...
    where the cost is determined by [your requested and approved allocation](../../get-started/get-an-allocation.md#general-user-view-of-openstack-resource-allocation)
    to reserve storage from the total pool. When you request additional storage
